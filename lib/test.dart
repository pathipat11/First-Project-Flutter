      ...
      body: Center(
        child: Card(
          ...
          shape: RoundedRectangleBorder(
            borderRadius: BorderRadius.circular(16), // มุมโค้งของ card
          ),
          margin: const EdgeInsets.symmetric(horizontal: 16, vertical: 32),
          child: Padding(
            padding: const EdgeInsets.all(16), // เพิ่มระยะห่างภายใน card
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 16), // ระยะห่างระหว่างรูปกับข้อมูล
                Text(
                  student.name,
